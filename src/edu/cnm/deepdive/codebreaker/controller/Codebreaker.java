 ...
 * guesses the code. After each guess, the program displays the results of that guess&mdash;name
...
private static final String CHARACTER_POOL = "ROYGBV";
  ...
  public static void main(String[] args)  {
    ...
    System.out.printf("pool: %s. Code length: %dn", CHARACTER_POOL, CODE_LENGTH);
    ...
    do{
      try {
        ...
        if (guess.getCorrect() == CODE_LENGTH){
          System.out.printf("congrats! The secret code was %s.%n", game.getCode());
          correct = true;
        }else {
